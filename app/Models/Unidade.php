...
class Unidade extends Model
{
    ...
    protected $showable = [
        ['name'=>'id',              'title'=>'Id',              'datatable'=>'true',  'form'=>'true',  'type'=>'id',   'size'=>'3',],
        ['name'=>'descricao',       'title'=>'Descricao',       'datatable'=>'true',  'form'=>'true',  'type'=>'text', 'size'=>'3',],
        ['name'=>'tipo_adicional',  'title'=>'Tipo Adicional',   'datatable'=>'true', 'form'=>'true',  'type'=>'select', 'size'=>'3',
        'options'=> [
            ['value'=>'Valor Fixo','label'=>'Valor Fixo'],
            ['value'=>'Percentual','label'=>'Percentual'],
        ],
        ],
        ['name'=>'adicional',        'title'=>'Adicional',      'datatable'=>'true',  'form'=>'true',  'type'=>'number', 'size'=>'3', 'step'=>'0.01',],
